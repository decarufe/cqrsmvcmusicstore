...
{
   internal class MessageHandlerCreator
   {
      ...
      internal static Type CreateCommandMessageHandlerForCommandMessageType(Type commandMessageType)
      {
         ...
         var parentType = typeof(CommandMessageHandler<>).MakeGenericType(commandMessageType);
         ...
         DefinePublicConstructor(typeBuilder, parentType, new Type[] { typeof(SimpleCqrs.Commanding.ICommandBus) });
